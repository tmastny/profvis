...
Yes. The main idea is to start and stop profiling as described in [this answer](#can-i-profile-code-without-using-profvis)). At the top of your app.R or server.R, you can add the following:
...
TODO: Write module for starting, stopping, viewing, downloading profile.
